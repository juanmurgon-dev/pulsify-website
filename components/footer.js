    ...
    <footer style={{ background: "#0E3A39", color: "white", padding: "48px 0", marginTop: "80px" }}>
      <div className="container">
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "32px", marginBottom: "32px" }}>
          <div><h4>PULSIFY</h4><p>Software para restaurantes.</p></div>
        ...
        <p style={{ textAlign: "center", borderTop: "1px solid rgba(255,255,255,0.1)", paddingTop: "32px" }}>&copy; 2024 PULSIFY</p>
      </div>
    </footer>
  );
}