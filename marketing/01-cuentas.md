...
## 1. Nombre para mostrar (display name)
...
## 4. Categoría de cuenta

### Instagram
- **Tipo:** cuenta de **Empresa (Business)**, no Creador. Te da botones de contacto, estadísticas completas y opción de anuncios más adelante.
- **Categoría a elegir:** `Software` o `Aplicación de productividad` (si no aparecen, usa `Empresa de tecnología` / `Servicio de software`).
- **Mostrar categoría en el perfil:** activada (aparece bajo el nombre y refuerza de qué eres).

### TikTok
- **Tipo:** cuenta **Business**. Da acceso a analíticas, enlace en bio garantizado y biblioteca de música comercial (importante: la música "solo Creador" tiene restricciones legales para negocios).
- **Categoría a elegir:** `Aplicaciones y software` o `Finanzas` (elige la que TikTok ofrezca; prioriza `Software/Tecnología`).
...
- **Formato:** cuadrado 1080x1080 px, exportado como PNG. El mismo archivo en ambas redes para consistencia de marca.
- **Prueba rápida:** míralo al tamaño de un ícono de app. Si no distingues el símbolo, simplifícalo.

---

## 6. Instagram Highlights (destacados)
...
5. **"Cómo empiezo"** — Paso a paso: entrar al link, registrarte, cargar ventas. Baja la fricción.
6. **"Dudas"** (opcional) — Preguntas frecuentes: seguridad de datos, pago con Stripe, qué pasa al salir de beta.

---

## 7. Info de contacto / botones de acción
...
- **Ubicación:** "México" a nivel país (mercado nacional, no una sola ciudad).
...
- [ ] Subir la misma foto de perfil que IG.
- [ ] Configurar botón de contacto (correo/WhatsApp si disponible).
- [ ] Publicar el video/post fijado y **fijarlo** (sección 9).
- [ ] Verificar que ambas cuentas tengan handle idéntico y branding consistente.

### Verificación básica
- [ ] Confirmar correo y teléfono en ambas plataformas (activa recuperación y da confianza).
- [ ] Activar verificación en dos pasos (2FA) en las dos cuentas.
- [ ] Guardar accesos en un gestor de contraseñas compartido del equipo.

---

## 9. Post fijado (pinned)

### Instagram (carrusel fijado)
**Objetivo:** que en 5 segundos entiendan el valor y sepan cómo empezar. Formato carrusel de 4-5 láminas:
1. Gancho: *"¿Sabes cuánto ganas DE VERDAD por platillo? La mayoría no."*
2. El problema: precios "al tanteo" = márgenes que no ves.
3. La solución: captura real de la app mostrando margen por platillo + alerta.
...
- **Hook (primeros 3 seg):** *"Tu platillo más vendido puede ser el que MENOS te deja."*
- **Desarrollo:** grabación de pantalla cargando ventas y viendo el margen real aparecer; señala la alerta de margen bajo y la "mina de oro".
