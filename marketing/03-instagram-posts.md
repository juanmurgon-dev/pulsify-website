...
**Formato:** Carrusel educativo de 6 slides.

**Objetivo/Pilar:** Educar + generar "aha" (dolor de no saber el margen).

**Hook (portada):** "Vendes 200 platos al día… ¿pero sabes cuánto GANAS de cada uno?"

**Contenido (texto en pantalla):**
- **Slide 1:** "Vendes 200 platos al día… ¿pero sabes cuánto GANAS de cada uno? 👀"
- **Slide 2:** "Vender ≠ ganar. Puedes tener el restaurante lleno y estar perdiendo dinero en tu platillo estrella."
...
**Hashtags:**
#restaurantesmexico #dueñoderestaurante #foodcost #margendeganancia #negociorestaurantero #taqueria #cafeteria #gastronomiamx #administraciondealimentos #restauranteros #emprendedormexicano #pymesmexico #controldecostos #rentabilidad #foodbusiness #cocinaprofesional

**Sugerencia visual/diseño:** Fondo claro (#ffeeb8 suave). Portada con número grande "200" en verde #0e3a39 y "¿cuánto GANAS?" en naranja #ff9f1c. Slide 5 con mockup de tarjeta de platillo: nombre "Chilaquiles", barra de margen al 38% en teal #2ec4b6 pasando a rojo. Tipografía Sora para titulares, Inter para cuerpo.

---

## POST 02

**Formato:** Reel (25–30 s).

**Objetivo/Pilar:** Demostrar el producto + "aha" (el platillo estrella que pierde).

**Hook (primeros 3s):** "Tu platillo más vendido puede ser el que MÁS te hace perder. Te enseño."
...
**Hashtags:**
#restaurantesmexico #foodcost #menuengineering #dueñoderestaurante #taqueria #fonda #cafeteria #rentabilidad #gastronomiamx #restauranteros #negociodealimentos #pymesmx #margendeganancia #emprendimientomexico #foodtruck #cocinamexicana

**Sugerencia visual/diseño:** Transiciones rápidas. Interfaz sobre fondo claro; alertas en rojo/naranja #ff9f1c, mina de oro en amarillo #ffeeb8 con brillo. Música trending upbeat. Subtítulos siempre visibles (mayoría ve sin sonido).

---

## POST 03

**Formato:** Carrusel educativo de 7 slides.
...
**Formato:** Imagen / quote sencilla.

**Objetivo/Pilar:** Educar/viralizar (mito "vendo mucho = gano mucho").

**Hook (texto principal en imagen):** "Vender mucho no es ganar mucho. Es solo mover mucho dinero ajeno."
...
Facturar $500k al mes suena increíble, pero si tu margen real es del 4%, estás trabajando para los proveedores, no para ti.
...
**Sugerencia visual/diseño:** Fondo verde #0e3a39 sólido, texto en amarillo #ffeeb8 (Sora bold). Detalle: un signo de "$" grande semitransparente en teal #2ec4b6 al fondo. Minimalista, alto contraste, muy legible en feed.
...
**Objetivo/Pilar:** Educar (punto de equilibrio explicado simple).

**Hook (portada):** "¿A qué hora del día tu restaurante EMPIEZA a ganar? (la mayoría no sabe)"

**Contenido (texto en pantalla):**
- **Slide 1:** "¿A qué hora del día tu restaurante EMPIEZA a ganar? ⏰"
...
**Caption:**
Pregunta rápida: ¿a partir de cuántas ventas tu restaurante DEJA de trabajar solo para pagar gastos y empieza a ganar? ⏰
...
**Hashtags:**
#puntodeequilibrio #restaurantesmexico #foodcost #finanzasrestaurante #dueñoderestaurante #administraciondealimentos #taqueria #fonda #cafeteria #gastronomiamx #restauranteros #pymesmx #rentabilidad #controldecostos #negociomexicano #emprendimientomx

**Sugerencia visual/diseño:** Slide 5 con mockup: gráfica de línea que cruza el "punto de equilibrio" (línea punteada en naranja #ff9f1c). Zona antes = gris, zona después = verde #0e3a39 con etiqueta "GANANCIA". KPI: "Faltan $2,400 para equilibrio". Paleta cálida, fondo claro.
...
**Objetivo/Pilar:** Convertir (precio de fundador $100 con urgencia).

**Hook (primeros 3s):** "$100 al mes por saber cuánto gana tu restaurante DE VERDAD. Pero no por mucho tiempo."

**Contenido (guion escena por escena):**
- **Escena 1 (0–3s):** Visual: dueño mirando el celular con cara de "wow". Texto: "$100/mes. Precio de fundador 🔒". Voz: "Cien pesos al mes. Menos que dos cafés."
- **Escena 2 (4–10s):** Visual: recorrido rápido por el panel (margen por platillo, alertas, mina de oro). Texto: "Margen real por platillo". Voz: "Ves el margen real de cada platillo, tu punto de equilibrio y alertas cuando algo baja."
- **Escena 3 (11–16s):** Visual: candado cerrándose sobre "$100". Texto: "Se congela mientras seas beta 🔒". Voz: "Este precio se te queda congelado mientras seas beta. Cuando salgamos de beta, sube."
- **Escena 4 (17–22s):** Visual: botón "Empezar" resaltado. Texto: "Cancela cuando quieras". Voz: "Sin amarres. Cancela cuando quieras."
- **Escena 5 (23–25s, CTA):** Texto grande: "Congela tu precio hoy 👉 Link en bio".
...
👉 Congela tu precio. Link en bio.

**Hashtags:**
#restaurantesmexico #foodcost #dueñoderestaurante #ofertaespecial #taqueria #cafeteria #gastronomiamx #restauranteros #pymesmx #rentabilidad #emprendedormexicano #appparanegocios #negociomexicano #controldecostos #beta #precioespecial

**Sugerencia visual/diseño:** Ritmo rápido, energía. Número "$100" enorme en verde #0e3a39 sobre fondo amarillo #ffeeb8. Ícono de candado teal #2ec4b6 con animación. Contador/urgencia sutil. Subtítulos grandes.

---

## POST 07

**Formato:** Carrusel (mini caso de éxito) de 6 slides.

**Objetivo/Pilar:** Convertir con prueba social ("subió $8k/mes").

**Hook (portada):** "Ajustó 3 platillos y su restaurante ganó $8,000 más al mes. Sin vender uno solo extra."
...
*(Ejemplo ilustrativo basado en escenarios típicos de food cost.)*

**Hashtags:**
#casodeexito #restaurantesmexico #foodcost #menuengineering #dueñoderestaurante #rentabilidad #taqueria #fonda #cafeteria #gastronomiamx #restauranteros #pymesmx #margendeganancia #negociomexicano #emprendimientomx #controldecostos

**Sugerencia visual/diseño:** Slide 1 con "+$8,000" gigante en verde #0e3a39. Slide 3 mockup con dos tarjetas de platillo en alerta naranja (34%). Slide 5 gráfica de barras antes/después de ganancia. Mantener nota de "ejemplo ilustrativo" pequeña para honestidad. Fondo claro, cálido.

---

## POST 08

**Formato:** Reel (tip rápido, 15–20 s).

**Objetivo/Pilar:** Educar (tip de food cost accionable).

**Hook (primeros 3s):** "La regla del 30% que todo restaurantero debería conocer (y casi nadie aplica)."
...
**Caption:**
Guárdalo para tu próxima junta de cocina. 📌
...
**Hashtags:**
#foodcost #tiprestaurantero #restaurantesmexico #cocinaprofesional #dueñoderestaurante #administraciondealimentos #taqueria #cafeteria #chef #gastronomiamx #restauranteros #pymesmx #rentabilidad #controldecostos #negociodealimentos #cocinamexicana

**Sugerencia visual/diseño:** Estilo "tip guardable". Fórmula grande en pantalla, colores teal #2ec4b6 y verde #0e3a39. Rango "28–35%" en naranja #ff9f1c. Ideal para guardados/compartidos. Subtítulos claros.

---

## POST 09

**Formato:** Carrusel de producto/demo de 5 slides.

**Objetivo/Pilar:** Demostrar (tour del panel).
...
3️⃣ Recibes alertas cuando algo baja de margen y ves tu punto de equilibrio en tiempo real.

Simple, claro y enfocado en lo único que importa: cuánto te quedas.

Beta $100/mes, precio de fundador. 👉 Link en bio.

**Hashtags:**
#restaurantesmexico #foodcost #appparanegocios #dueñoderestaurante #demo #taqueria #cafeteria #gastronomiamx #restauranteros #pymesmx #rentabilidad #tecnologiaparanegocios #controldecostos #negociomexicano #emprendimientomx #softwarederestaurantes

**Sugerencia visual/diseño:** Cada slide un screenshot real/mockup del panel sobre fondo claro. Destacar KPI grande "62%" en verde, tarjeta con alerta "Sopa 38% ⚠️" en naranja/rojo, y widget de punto de equilibrio. Marco de teléfono limpio. Consistencia Sora + Inter.

---

## POST 10

**Formato:** Reel (storytelling/dolor, 25–30 s).

**Objetivo/Pilar:** Educar + convertir (dolor de no saber el margen).

**Hook (primeros 3s):** "El restaurante estaba SIEMPRE lleno. Cerró en 8 meses. Esto fue lo que pasó."

**Contenido (guion escena por escena):**
- **Escena 1 (0–4s):** Visual: local lleno, ambiente animado (B-roll). Texto: "Siempre lleno 🔥". Voz: "Este lugar siempre estaba a reventar."
...
He visto restaurantes con fila en la puerta cerrar en menos de un año. ¿La razón? Vendían mucho pero ganaban poco… y nunca lo midieron a tiempo.
...
**Objetivo/Pilar:** Educar/generar guardados (mito del platillo estrella).

**Hook (texto principal en imagen):** "Tu platillo más vendido no es tu jefe. Tu platillo más RENTABLE sí."
...
🔥 El más VENDIDO llena las mesas y da fama.
💰 El más RENTABLE llena tu bolsa.
...
**Hashtags:**
#menuengineering #restaurantesmexico #foodcost #dueñoderestaurante #frasesdenegocios #rentabilidad #taqueria #cafeteria #gastronomiamx #restauranteros #pymesmx #margendeganancia #negociomexicano #emprendimientomx #cocinaprofesional #negociosrentables

**Sugerencia visual/diseño:** Composición dividida en dos: lado "más vendido" con ícono 🔥 en naranja #ff9f1c, lado "más rentable" con 🏆 en amarillo #ffeeb8. Texto en verde #0e3a39 sobre fondo claro. Sora bold para la frase. Muy compartible.

---

## POST 12

**Formato:** Carrusel de producto/demo de 6 slides.
...
- **Slide 5:** "4. Alertas ⚠️ cuando un platillo baja de margen. 5. Cuánto ganas DE VERDAD al mes."
- **Slide 6 (CTA):** "Todo por $100/mes en beta. Precio congelado. Cancela cuando quieras. 👉 Link en bio."
...
✅ Alertas cuando algo baja de margen
✅ Cuánto ganas DE VERDAD al mes

Todo por $100/mes en beta. Precio de fundador congelado. Cancela cuando quieras. 💳

👉 Empieza hoy. Link en bio.

**Hashtags:**
#restaurantesmexico #foodcost #dueñoderestaurante #appparanegocios #menuengineering #taqueria #fonda #cafeteria #gastronomiamx #restauranteros #pymesmx #rentabilidad #controldecostos #negociomexicano #emprendimientomx #softwarederestaurantes

**Sugerencia visual/diseño:** Formato lista con checkmarks teal #2ec4b6. Cada slide un ícono grande + un screenshot pequeño del panel correspondiente (margen, mina de oro dorada, punto de equilibrio, alerta naranja). Slide final con botón "Empezar" resaltado en naranja #ff9f1c sobre verde #0e3a39. Cierre fuerte y claro.
